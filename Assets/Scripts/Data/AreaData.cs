...
namespace Assets.Scripts.Data
{
	...
	public class AreaData : ScriptableObject
	{
		...
		public RoomNode roomHead;

		public int currentMapSize; //to keep track of map size as a listnode cant have a count value
...
[System.Serializable]public struct RoomData
{
	...
	public RoomData(GameObject room, Vector2 pos, List<Wall> walls)
	{
		this.roomPrefab = room;
		this.position = pos;
...
[System.Serializable]
public class RoomNode : ListNode<RoomData>
{
	public GameObject roomInstance;
	public new RoomNode next;

	public RoomNode(GameObject room, RoomData value, RoomNode next = null) : base(value, next)
	{
